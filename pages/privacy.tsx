        ...
        <>
            <div className="h-full w-full flex justify-center items-center m-8">
                <div className=" c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden p-8">
                    ...
                    <p>
                        At Plante, accessible from Planteapp.com, one of our main priorities is the privacy of our
                        visitors. This Privacy Policy document contains types of information that is collected and
                        recorded by Plante and how we use it.
                    </p>
                    ...
                    <p>
                        ...
                        website with regards to the information that they shared and/or collect in Plante. This policy
                    ...
                    <p>
                        Plante follows a standard procedure of using log files. These files log visitors when they visit
                    ...
                    <p>
                        ...
                        that are used in their respective advertisements and links that appear on Plante, which are sent
                    ...
                    <p>
                        Note that Plante has no access to or control over these cookies that are used by third-party
                        advertisers.
                    </p>
                    ...
                    <p>
                        Plante's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                    ...
                    <p>
                        Plante does not knowingly collect any Personal Identifiable Information from children under the
